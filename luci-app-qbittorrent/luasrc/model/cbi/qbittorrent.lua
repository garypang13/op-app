...
m = Map("qbittorrent", translate("qBittorrent"), "%s <br\> %s" % {translate("A BT/PT downloader base on Qt. Refer to "
	.. "<a href='https://github.com/qbittorrent/qBittorrent/wiki/Explanation-of-Options-in-qBittorrent'  target='_blank'>help</a>"),
